...
shinyUI({
  ...
  dbHeader <- dashboardHeader(title = "El crimen en México.",
                              ...
                              tags$li(a(href = 'https://www.colmex.mx',
                                        ...
                                        style = "padding-top:0px; padding-bottom:0px;padding-right:15px; padding-left:15px;"),
                                      class = "dropdown"), 
                              tags$li(a(href = 'https://github.com',
 ...
 li {
  ...
  tabItems(
    ...
    tabItem("tabNIVEL_ESTATAL", 
            ...
            fluidPage(
              fluidRow(
                ...
                column(2,tags$li(a(href = 'https://www.gob.mx/sesnsp/acciones-y-programas/incidencia-delictiva-del-fuero-comun-nueva-metodologia?state=published',
                                   img(src = 'https://www.ordenadorpolitico.com/wp-content/uploads/2017/11/1-268.jpg',style = "width:280px;height:130px; padding-left:0px; padding-right:40px")), style = "list-style-type: none")))
            ),
            ...
            fluidPage(
              fluidRow(
                column(2,tags$li(a(href='http://economicsandpeace.org/reports/',
                                   img(src = 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/Institute_for_Economics_and_Peace_Logo.svg/220px-Institute_for_Economics_and_Peace_Logo.svg.png', style = "padding-right: 20px; padding-left:60px; padding-top:10px; padding-bottom:0px; width:200px;height:120px")), style = "list-style-type: none")),
            ...
            fluidPage(
              fluidRow(
                column(12, box(title = "Mapa de la República Mexicana", status = 'primary', solidHeader = FALSE, width = 12, collapsible = TRUE, 
                               # Contenido
            ...
            fluidPage(
              fluidRow(
                column(6, box(title = "Crímenes a la persona a Nivel Estatal", status = 'primary', solidHeader = FALSE, width = 12, collapsible = TRUE, 
                              withSpinner(plotlyOutput("dona", width = "100%")) 
                )
                ), 
                column(6, box(title = "Pobreza", status = 'primary', solidHeader = FALSE, width = 12, collapsible = TRUE, 
              ...
              fluidRow(
                ...
                column(6, box(title = "Rezago", status = 'primary', solidHeader = FALSE, width = 12, collapsible = TRUE, 
    ...
    tabItem("tabNIVEL_MUNICIPAL", 
            ...
            fluidPage(
              fluidRow(
                column(12, selectInput(inputId = 'sPeriodo', 
